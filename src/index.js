...
const storePlayerName = "PPName";
const storePlayerScore = "PPMaxScore";
...
(function () {
  rod = localStorage.getItem(storePlayerName);
  maxScore = localStorage.getItem(storePlayerScore);
...
function resetGameBoard(rodName) {
...
function storeWinData(rod, score) {
  if (score > maxScore) {
    maxScore = score;
    localStorage.setItem(storePlayerName, rod);
    localStorage.setItem(storePlayerScore, maxScore);
  }
